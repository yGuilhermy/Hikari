...
const CONFIG_PAGES = [
    ...
    },
    {
        ...
        description: 'Controla se a Hikari pode ler registros no banco de dados interno (como os dados do criador) para responder perguntas sem consumir tokens no prompt. Se desativado, a escrita, a edição e a deleção também serão bloqueadas.',
    ...
    {
        key: 'aiDbEdit',
        label: 'Banco de Dados da IA — Edição',
        category: '🧠 IA — Memória & Dados',
        icon: '✏️',
        type: 'boolean',
        persistence: 'runtime',
        summary: 'Permite à IA editar registros existentes.',
        description: 'Controla se a Hikari pode alterar ou acrescentar dados em registros já salvos no banco de dados interno. Se a Leitura estiver desativada, a edição é bloqueada automaticamente.',
        get: () => getDbSettings().aiDbEdit,
        set: (v) => updateDbSetting('aiDbEdit', v),
    },
    {
        key: 'aiDbDelete',
    ...
    },
    {
        ...
        label: 'Voz da Hikari no Chat',
        category: '🎙️ Voz & Áudio (TTS)',
        icon: '🎙️',
        type: 'boolean',
        persistence: 'json',
        configKey: 'voiceChatEnabled',
        summary: 'Ativa ou desativa mensagens de voz da Hikari.',
        description: 'Controla se a Hikari pode enviar áudios de microfone (Discord Voice Messages). Se desativado, o bot responderá apenas em texto, mesmo se solicitado.',
    },
    {
        key: 'voiceSpontaneousEnabled',
        label: 'Áudio Espontâneo no Chat',
        category: '🎙️ Voz & Áudio (TTS)',
        icon: '🎲',
        type: 'boolean',
        persistence: 'json',
        configKey: 'voiceSpontaneousEnabled',
        summary: 'Permite áudios autônomos ocasionais.',
        description: 'Quando ativado, a Hikari tem uma chance probabilística de enviar sua resposta por áudio de microfone mesmo sem o usuário ter pedido.',
    },
    {
        key: 'voiceSpontaneousChance',
        label: 'Chance de Áudio Espontâneo (%)',
        category: '🎙️ Voz & Áudio (TTS)',
        icon: '📈',
        type: 'number',
        persistence: 'json',
        configKey: 'voiceSpontaneousChance',
        summary: 'Probabilidade de áudio espontâneo.',
        description: 'Porcentagem de chance (1% a 100%) da Hikari mandar um áudio de forma autônoma numa resposta comum. Padrão: 5%.',
        min: 1, max: 100, step: 1,
    },
    {
        key: 'voiceCooldownMinutes',
        label: 'Cooldown de Áudio por Canal (min)',
        category: '🎙️ Voz & Áudio (TTS)',
        icon: '⏳',
        type: 'number',
        persistence: 'json',
        configKey: 'voiceCooldownMinutes',
        summary: 'Intervalo mínimo entre áudios espontâneos.',
        description: 'Tempo mínimo de espera em minutos para que a Hikari mande outro áudio espontâneo no mesmo canal, evitando queimar cota do Modal. Padrão: 15 min.',
        min: 1, max: 120, step: 1,
    },
    {
        key: 'voiceMaxChars',
        label: 'Limite de Caracteres da Voz',
        category: '🎙️ Voz & Áudio (TTS)',
        icon: '📏',
        type: 'number',
        persistence: 'json',
        configKey: 'voiceMaxChars',
        summary: 'Teto de caracteres para síntese de voz.',
        description: 'Número máximo de caracteres permitidos para sintetizar em áudio. Frases curtas sintetizam mais rápido e poupam cota. Padrão: 350.',
    ...
    },
    {
        ...
        type: 'number',
        persistence: 'json',
        configKey: 'voiceSpeed',
        summary: 'Velocidade de reprodução da fala.',
        description: 'Velocidade do sintetizador XTTS v2. Padrão: 1.15 (natural e dinâmica).',
...
const envConfigMap = {
    ...
    voiceSpontaneousEnabled: 'VOICE_SPONTANEOUS_ENABLED',
    voiceSpontaneousChance: 'VOICE_SPONTANEOUS_CHANCE',
    voiceCooldownMinutes: 'VOICE_COOLDOWN_MINUTES',
    voiceMaxChars: 'VOICE_MAX_CHARS',
