...
const TOOL_DESCRIPTIONS = {
    ...
    'db_read': '**Propósito:** Permite à Hikari consultar memórias e registros guardados no banco de dados interno sob demanda (como dados do criador ou sobre ela própria).\n\n**Como Usar:** Pergunte sobre o criador da Hikari, sobre a aparência e personalidade dela ou sobre um tópico salvo.\n\n**Gatilhos Típicos:** *"quem é seu criador?"*, *"como é sua aparência?"*, *"gere uma imagem sua"*, *"consulte no banco X"*.\n\n**Saída:** Dados recuperados e reformulados na resposta.',
